...
class StellaProcessor(Qwen2_5_VLProcessor):
...
class ColStella2_5_Processor(BaseVisualRetrieverProcessor, StellaProcessor):
    """
    Processor for ColStella.
    """

    visual_prompt_prefix: ClassVar[str] = "[IMG]"
